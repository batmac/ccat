#!/bin/sh
set -e
# Code generated by godownloader on 2022-08-19T16:45:42Z. DO NOT EDIT.
#
# modified to add checksums check and untar

usage() {
  this=$1
  cat <<EOF

$this: download binaries for batmac/ccat

Usage: $this [-b bindir] [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
  [tag] is a tag from
  https://github.com/batmac/ccat/releases
...
execute() {
  ...
  log_info "downloading from ${CHECKSUMS_URL}"
  http_download "${TMPDIR}/${CKSUMS}" "$CHECKSUMS_URL"
  log_info "verifying sha256"
  hash_sha256_verify "${TMPDIR}/${NAME}" "${TMPDIR}/${CKSUMS}"

  test ! -d "${BINDIR}" && install -d "${BINDIR}"
  (cd "${TMPDIR}" && untar "${TMPDIR}/${NAME}")
...
NAME=${BINARY}-${VERSION}-${OS}-${ARCH}.tar.gz
...
CHECKSUMS_URL=${GITHUB_DOWNLOAD}/${TAG}/${CKSUMS}
# do it
execute
