...
## install
- get the latest release from [here](https://github.com/batmac/ccat/releases/latest)
...
## help
```
version v0.9.20-20-gdd2754a [libcurl,crappy], commit dd2754a09c609a3ffab85e01668ac616b6d58957, built at 2022-08-04@15:34:16 by build.sh (go1.18.5 darwin/arm64)
